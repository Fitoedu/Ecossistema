...
import PageController from '@/features/cartilha/components/PageController'
import PageTransitionWrapper from '@/features/cartilha/components/PageTransitionWrapper'
import {
  PageCover,
  PageContent,
  PageLapbook,
  ...
  PageFindTheHero,
  PageClosing,
} from '@/features/cartilha/components/BookletPages'
import {
  getPage,
  TOTAL_PAGES,
  type CartilhaPageData,
} from '@/features/cartilha/data/cartilha-data'
